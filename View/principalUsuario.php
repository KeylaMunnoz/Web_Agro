...
$sqlP = $con->prepare("SELECT idProducto, nombre, precio,imagen FROM productos"); 
$sqlP->execute();
				...
				<div class="container hero">
					...
					<?php
						if(isset($_GET['nombreBase'])){
							$nombre = $_GET['nombreBase'];
						} 
						
						if(isset($_GET['correoBase'])){
							$correo = $_GET['correoBase'];
						}
					...
					<div class="container-user">
						...
						<div class="content-shopping-cart">
							<a href="../Model/checkout.php?nombre2=<?php echo $nombre;?>&correo2=<?php echo $correo;?>">
    ...
    dropdown.style.display = 'none';
		...
		<main class="main-content">
			...
			<section class="container top-categories" id="container top-categories">
				<h1 class="heading-1">Categorías</h1> <br>
				<div class="carousel-wrapper">
					<div class="container-categories" id="category-carousel">
					<div class="card-category category-prod">
                                <br><br><br>
                                <p>Todos los productos</p><br>
                                <a class="ver-mas" href="../View/principalUsuario.php?nombreBase=<?php echo $nombre?>&correoBase=<?php echo $correo?>">Mostrar</a>
                         </div>
						...
						<?php foreach ($resultadoC as $row) { ?>
							<div class="card-category category-prod">
								...
								<a class="ver-mas" href="../Model/principalUsuario2.php?id=<?php echo $row['id']; ?>&nombre2=<?php echo $nombre;?>&correo2=<?php echo $correo;?>">Mostrar</a>
							</div>
						<?php } ?>
					</div>
...
<section class="container-products">
			<?php foreach ($resultadoP as $row) { ?>
				...
				<img src="<?php echo $row['imagen']; ?>"  width="100%"/>
				...
				<div class="content-card-product">
					...
					<a href="../Model/DetallesProductos.php?idProducto=<?php echo urlencode($row['idProducto']); ?>&token=<?php echo urlencode(hash_hmac('sha1', $row['idProducto'], KEY_TOKEN)); ?>&nombre2=<?php echo $nombre;?>&correo2=<?php echo $correo;?>" class="add-cart btn">
					<i class="fa-solid fa-basket-shopping"></i>
				    </a>
			...
			<section class="container blogs" id="container blogs">
				...
				<div class="container-blogs" id="container-blogs">
					<div class="card-blog">
						<div class="container-img">
			...
			<div class="container container-footer">
				<div class="menu-footer">
					...
					<div class="information">
						<p class="title-footer">Información</p>
						<ul>
							<li><a href="#modal1">Acerca de Nosotros</a></li>
							<li><a href="#modal2">Politicas de Privacidad</a></li>
						</ul>
					</div>
